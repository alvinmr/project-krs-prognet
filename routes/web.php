...
Route::prefix('mahasiswa/')->name('mahasiswa.')->group(function () {
    ...
    Route::middleware('auth:mahasiswa')->group(function () {
        ...
        /* krs */
        Route::get('krs', [KRSController::class, 'showTableKRS'])->name('krs-index');

        /* krs detail */
        Route::get('krs/detail/{id}', [KRSController::class, 'showDetailMatakuliah'])->name('krs-detail', 'id');

        /* krs-create */
        Route::get('krs/create', [KRSController::class, 'showCreateTableKRS'])->name('krs-create');
        Route::post('krs/store/{id}', [KRSController::class, 'storeKRS'])->name('krs-store', 'id');

        /* krs-edit */
        Route::get('krs/edit', [KRSController::class, 'showEditTableKRS'])->name('krs-edit');
        Route::post('krs/storeedit', [KRSController::class, 'storeEditTableKRS'])->name('krs-store-edit');

        /* krs-delete */
        Route::get('krs/delete', [KRSController::class, 'showDeleteTableKRS'])->name('krs-delete');
        Route::post('krs/storedelete/{id}', [KRSController::class, 'storeDeleteTableKRS'])->name('krs-store-delete', 'id');
