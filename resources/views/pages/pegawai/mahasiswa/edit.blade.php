...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('pegawai.mahasiswa.update', $mahasiswa->id) }}" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama"
                        placeholder="Contoh : Alvin Maulana Rhusuli" name="nama"
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" cols="30"
                        rows="10" placeholder="Contoh : Jl. Kudu Sari">{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                    @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control @error('telepon') is-invalid @enderror" id="telepon"
                        placeholder="Contoh : 089670455567" name="telepon"
                ...
                <div class="form-group">
                    ...
                    <select name="angkatan" class="form-control @error('angkatan') is-invalid @enderror" id="angkatan">
                        ...
                        @foreach ($angkatans as $item)
                            <option value="{{ $item }}"
                                {{ old('angkatan', $mahasiswa->angkatan) == $item ? 'selected' : '' }}>
                                {{ $item }}</option>
                        @endforeach
                    </select>
                    @error('angkatan')
                    ...
                    <select name="prodi" class="form-control @error('prodi') is-invalid @enderror" id="prodi">
                        ...
                        @foreach ($prodis as $item)
                            <option value="{{ $item->id }}"
                                {{ old('prodi', $mahasiswa->prodi_id) == $item->id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    <label for="unggahFoto">Ubah Foto Mahasiswa</label>
